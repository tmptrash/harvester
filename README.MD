...
### 2. Score
The next concept to understand is **scores**. Scores are how this library determines how well the extracted data matches our template. What does this mean?  
