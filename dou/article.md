...
На малюнку показано як саме бібліотека порівнює два дерева - дерево наших даних, яке ми отримали із DSL шаблона (на малюнку зліва - klm) і DOM дерево (на малюнку правіше 1234...). Справа і знизу Ви можете побачити частину варіантів, які бібліотека порівнює. 
