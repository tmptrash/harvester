...
## Use with puppeteer
This library works perfectly in combination with [Puppeteer](https://pptr.dev). Here's an example where we extract all today's news from the Ukrainska Pravda website.
